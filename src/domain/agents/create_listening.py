...
Your job is to create a listening excercise for students from given text source.
Given the level of A1, A2, B1, B2, C1 and C2, create an appropriate listening excercise.
...
async def generate_listening_lesson(text: str, level: str):
    agent = Agent(
        get_gemini(), system_prompt=SYSTEM_PROMPT, output_type=ListeningExercise
    )
